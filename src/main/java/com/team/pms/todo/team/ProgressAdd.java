...
@WebServlet("/todo/team/progressadd.do")
public class ProgressAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ArrayList<ProgressDTO> list = dao.getProgress(employeeseq, trLen + 1);
		...
		for (ProgressDTO dto : list) {
			...
			obj.put("percent", dto.getPercent());
